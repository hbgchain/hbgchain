...
const QString BITCOIN_IPC_PREFIX("HBGChain:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click HBGChain: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start HBGChain: click-to-pay handler");
    else
...
{
    // clicking on HBGChain: URLs creates FileOpen events on the Mac:
